...
public class Tabell {
    ...
    public static int[] randPerm(int n)  // virker, men er lite ineffektiv
    {
    ...
    public static <T> void kvikksortering(T[] a, Comparator<? super T> c) { kvikksortering(a, 0, a.length - 1, c); }
